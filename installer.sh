...
# OpenVPN Login
cd ~
wget -O /etc/openvpn/login.sh "http://$WEBSCRIPT/script/ubuntu/aio/files/login.sh"
...
wget -O /root/socksDirect.py "http://$WEBSCRIPT/script/ubuntu/aio/files/socksDirect.py"
chmod +x /root/socksDirect.py
screen -d -m python socksDirect.py

wget -O /root/socksDirect2.py "http://$WEBSCRIPT/script/ubuntu/aio/files/socksDirect2.py"
...
cd ~
wget -O /root/update.sh "http://$WEBSCRIPT/script/ubuntu/aio/files/update.sh"
...
wget -O /home/multilogin "http://$WEBSCRIPT/script/ubuntu/aio/files/multilogin"
...
wget -O /etc/stunnel/stunnel.pem "http://$WEBSCRIPT/script/ubuntu/aio/files/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "http://$WEBSCRIPT/script/ubuntu/aio/files/stunnel.conf"
...
wget -O /root/ddos-deflate-master.zip "http://$WEBSCRIPT/script/ubuntu/aio/files/ddos-deflate-master.zip"
...
curl -O http://$WEBSCRIPT/script/ubuntu/aio/files/squid3
